...
public class PostBO {
	...
	public List<Post> getPostListByUserId(int userId, Integer prevId, Integer nextId) {
		...
		if (prevId != null) {	// 2) 이전
			...
			List<Post> postList = postMapper.selectPostListByUserId(userId, standardId, direction, nextId);
			// [5, 6, 7] => [7, 6, 5]
	...
	public boolean isNextLastPageByUserId(int userId, int nextId) {
		int minPostId = postMapper.selectPostIdByUserIdAsSort(userId, "DESC");
